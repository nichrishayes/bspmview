...
function cmap   = default_colormaps(depth)
    ...
    blue_r = brewermap(36, '*Blues');
    reds = brewermap(36, 'Reds');
    reds_r = brewermap(36, '*Reds');
    greens = brewermap(36, 'Greens');


    cmap{end+1,1} = [blue_r(1:32,:); reds(5:36,:)];
    cmap{end,2} = 'Blue-Red';
    cmap{end+1,1} = [blue_r(1:32,:); greens(5:36,:)];
    cmap{end,2} = 'Blue-Green';
    cmap{end+1,1} = [reds_r(1:32,:); greens(5:36,:)];
    cmap{end,2} = 'Red-Green';
